...
def index(request):
    ...
    return render(request, "wishing/index.html")
...
def dashboard(request):
    ...
    return render(request, "wishing/main.html", context)
...
def create(request):
    ...
    return render(request, 'wishing/create.html')
...
def item(request, id):
    ...
    return render(request, "wishing/item.html", context)
